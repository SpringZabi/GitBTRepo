...
public class eCommerce_tc_4ScrollandAddProducttoCartandVerifytheTotalAmount extends BaseTest {
	...
	public  void Fillform() throws InterruptedException {
		...
		//In this script we use to add the multiple products to the page and we use to verify the price
